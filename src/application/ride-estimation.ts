import { Address, estimateForItinerary, Estimation, Estimations, Itineraries, Itinerary, Route, ServedCities, ServedCity, Street } from "../domain"
...
export class RideEstimationCommandHandler {
    ...
    constructor(servedCities: ServedCities, itineraries: Itineraries, estimations: Estimations) {
