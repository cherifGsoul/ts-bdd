...
import { serveCity } from '../../src/infrastructure/persistence/in-memory/in-memory-served-cities';
...
Given(
  '{string} is a served city',
  async function (this: ShellWorld, city: string) {
    pipe(
      ServedCity.fromString(city),
      E.match(TE.left, serveCity)
    )
  }
);
...
//   function (this: ShellWorld, origin: string, destination: string) {
...
//     this.route = Route.between(originAddress, destinationAddress);
//   }
// );

// Given(
//   'the itinerary distance for this route is {int} KM',
//   function (this: ShellWorld, distance: number) {
...
// When(
//   'I request an estimation for a ride for this route',
//   async function (this: ShellWorld) {
//     const { route } = this;
...
//       },
//     };
//     const commandHandler = new RideEstimationCommandHandler(
//       this.servedCities,
//       this.itineraries,
//       this.estimations
//     );
...
// Then(
//   'the estimated price should be ${int}',
//   async function (this: ShellWorld, fare: number) {
